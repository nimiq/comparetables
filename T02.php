...
$commFinale = "NOTA: La tabella contiene tutti gli articoli del primo tipo (media)
La 'chiave univoca' e' il campo xyz (codice articolo)";
...
$page->addBodyContent("<p><a href='T02inv.php'>[Controllo inverso]</a><br>");
